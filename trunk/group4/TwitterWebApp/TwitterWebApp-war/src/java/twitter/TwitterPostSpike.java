...
/** Jersey REST client generated for REST resource:Twitter OAuth [direct_messages/new.{format}]<br>
 *  USAGE:<pre>
 *        TwitterPostSpike client = new TwitterPostSpike();
...
public class TwitterPostSpike {
    ...
    public TwitterPostSpike(String format) {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        String resourcePath = java.text.MessageFormat.format("direct_messages/new.{0}", new Object[]{format});
     ...
     * @param text form parameter
     * @return response object (instance of responseType class)
     */
    public <T> T sendNewDirectMessageFromMe(Class<T> responseType, String user, String text) throws UniformInterfaceException {
        String[] formParamNames = new String[]{"user", "text"};
        String[] formParamValues = new String[]{user, text};
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            try {
                ...
                if (uiEx == null) {
                    ...
                    out.println("   TwitterPostSpike client = new TwitterPostSpike(...);");
